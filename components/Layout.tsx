  ...
  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden">
        ...
        <div className="p-4 border-t border-slate-800">
          <div className="flex items-center gap-3 mb-4 px-2">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-xs text-slate-500 uppercase tracking-widest">Manager</p>
            </div>
          </div>
          <button 
            onClick={onLogout}
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Top Header - Mobile & Desktop Header Info */}
        <header className="bg-white border-b border-gray-200 px-4 py-3 md:px-8 flex items-center justify-between">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-slate-900 text-white absolute top-14 left-0 w-full z-50 border-t border-slate-800">
            <nav className="p-4 space-y-2">
              ...
              <button 
                onClick={onLogout}
                className="w-full flex items-center gap-3 px-4 py-3 text-red-400 hover:bg-red-900/20 rounded-lg"
              >
                <i className="fas fa-sign-out-alt"></i>
                <span>Logout</span>
              </button>
